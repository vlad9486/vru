...
pub trait PolySize {
    ...
    type CompressedSlightlyBytes: ArrayLength<u8>;
...
where
    U: Unsigned + Mul<typenum::U8> + Mul<typenum::U3> + Mul<typenum::U11> + Mul<typenum::U13> + Mul<typenum::U4>,
    ...
    <U as Mul<typenum::U4>>::Output: ArrayLength<Coefficient>,
{
    ...
    type CompressedSlightlyBytes = <U as Mul<typenum::U11>>::Output;
